...
class RegisterPage(QMainWindow):
    ...
    def handle_register(self):
        ...
        if(fullname_input.strip() == ""):
            self.show_message(" vui long nhap day du ho ten")
    ...
    def __goto_home(self):
        ...
        home_page = HomePage(main_window=self.main_window, root_dir=self.root_dir, cur_acc = account)
        self.close()  # ✅ đóng cửa sổ
